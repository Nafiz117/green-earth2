document.addEventListener('DOMContentLoaded', () => {
  ...
  const showCategory = (categories) => {
    ...
    const makePill = (id, text, isPrimary = false) => {
      ...
      span.className = `category-btn inline-block px-3 py-1 rounded cursor-pointer mr-2 md:mr-0 whitespace-nowrap ${isPrimary ? 'text-green-700 font-semibold' : 'text-gray-700 hover:bg-green-700 hover:text-white'}`;
      span.dataset.id = id;
